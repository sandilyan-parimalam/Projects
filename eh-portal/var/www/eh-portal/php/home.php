...
<body  background="/eh-portal/images/background.jpg"> 
	<p align=right><font color=white><b><strong>Welcome <?php $usr= $_SESSION['login_user']; echo $usr; ?> <font color=red>| </font><a href="LogOut.php?username=<?php echo $_SESSION['login_user']; ?>" style="text-decoration:none;color:white;"> Logout  </a><font color=red>| </font><a href="LogViewer.php" style="text-decoration:none;color:white;"> View Logs  </a></strong></b></font> </p>
		...
		<div class="div_items">
			...
			<ul style="border-top: 1px solid black;">
			  ...
			  <li><a  href="/eh-portal/php/lin4vz_portal.php" target="_blank"><font color=green>ASPLIN4VZ</font></a></li>
